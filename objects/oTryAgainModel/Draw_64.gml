...
// scale offsets (tie title+button pos to panel size; label to button size)
...
// hover/press as before...
// draw_sprite_stretched_ext(...) as before...
...
// --- button label (apply label_off_y) ---
draw_set_color(c_white);
draw_set_halign(fa_center);
draw_set_valign(fa_middle);
